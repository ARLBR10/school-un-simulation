...
Any way of free hosting is welcome, me ([@ARLBR10](https://github.com/ARLBR10)) is planning to use the free tier of [Convex](https://www.convex.dev/) and [Cloudflare Workers](https://workers.cloudflare.com/) with [OpenNext](https://opennext.js.org/cloudflare).
...
bun run dev # This just runs NextJS and Convex at dev simultaneously
```
